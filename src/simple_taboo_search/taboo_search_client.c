...
#define BCINCREASE_THRESHOLD (1000) /* Attempts of decreasing the best count */
#define ITERATIONS_THRESHOLD (2000) /* How many iterations will be done before randomizing */
